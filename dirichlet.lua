...
function StartValue_u2d(x,y,t) return 0 end
function StartValue_v2d(x,y,t) return 0 end
function StartValue_p2d(x,y,t) return 0 end

function StartValue_u3d(x,y,z,t) return 0 end
function StartValue_v3d(x,y,z,t) return 0 end
...
if dim==3 then
	Interpolate("StartValue_w"..dim.."d", u, "w")
end
